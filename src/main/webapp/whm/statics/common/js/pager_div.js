(function(window,undefined){
    ...
    var tool = {
        ...
        ajaxAction :  function(pager,begin,end) {
            ...
            $.ajax({
            	...
            	success : function(data) {
            		...
            		$(setting.base.divShow).find("#consultPagerList").replaceWith(data);
        ...
        init : function(pager,pagerDiv) {
        	...
        	var html = '<div id="'+pagerDiv+'" class="fenye-bk" style="display : none;">' +
                        ...
                        '<span>跳转到&nbsp;&nbsp;</span>'  +
                        '<input name="" class="fenye-srk" type="text" onkeyup = "javascript:pager.checkInput(this)" id="jumpPage"/>'+
                        '<span>&nbsp;&nbsp;页</span>'+
        	...
        	$(divShow).after(html);
        	$(divShow).after("<div class='clear'></div>");
        },
	...
	Pager.prototype = {
		 ...
		 * @param setting
		 */
		init : function (setting,pagerDiv) {
			$.extend(true,this.setting,setting);
			tool.init(this,pagerDiv);
		},
