define(function(require,exports,module) {
    ...
    exports.scroll = function(viewid, scrollid, size) {
        // 获取滚动条容器
...
//        bak.style.backgroundColor = "#cfc";
    ...
    exports.sortTable= function(sTableId, iCol, sDataType) {
    ...
    exports.getSortFunction=function(iCol, sDataType) {
         var convert = function(sValue, sDataType) {
             switch (sDataType) {
                 case "int":
         ...
         return function compareTRs(oTR1, oTR2) {
            ...
            if (oTR1.cells[iCol].getAttribute("value")) {
                vValue1 = this.convert(oTR1.cells[iCol].getAttribute("value"), sDataType);
                vValue2 = this.convert(oTR2.cells[iCol].getAttribute("value"), sDataType);
            }
            else {
...
//                 return -1
//             } else if(vValue1.length > vValue2.length){
//                 return 1
//             } else {
...
//                }
//                else {
//                    vValue1 = this.convert(oTR1.cells[iCol].firstChild.nodeValue, sDataType);
//                    vValue2 = this.convert(oTR2.cells[iCol].firstChild.nodeValue, sDataType)
//                }
//                if (vValue1 < vValue2) {
//                    return -1;
//                }
