...
<head>
    ...
    <script src="${ctx}/whm/statics/common/js/jquery-1.11.2.js"></script>
    <link href="${ctx}/whm/statics/pages/css/index/css/login.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/whm/statics/pages/css/index/css/public.css" rel="stylesheet" type="text/css">
    <link href="${ctx}/whm/statics/pages/css/index/css/icon.css" rel="stylesheet" type="text/css">
    <script language="javascript" src="${ctx}/whm/statics/pages/login.js?_dc=${staticVersion}"></script>
...
<div class="wrap100 loginTopBg">
    <div class="wrap"><img src="${ctx}/whm/statics/pages/css/index/images/food_logo.png"></div>
</div>
<!--top end-->

<!--loginContent begin-->
<div class="wrap loginContent">
    <div class="fl leftAdver"><img src="${ctx}/whm/statics/pages/css/index/images/leftAdver1.jpg"/></div>
    <!--login begin-->
    ...
    <form id="loginForm" method="post" action="${ctx}/whm/index.html">
        ...
        <div class="fl loginList" id="normal">
            ...
            <ul>
                ...
                <li>
                    ...
                    <img id="imageCheckCode" src="${ctx}/whm/common/checkCode/code?page=login_user"/>
                </li>
            </ul>
...
<!--copyright begin-->
<div class="wrap100 copyright">©2017 张薛. All rights reserved.</div>
<!--copyright end-->
